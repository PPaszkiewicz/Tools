...
/*
* Clone of FixedSizeTextView but extends out of Chronometer.
* */
 ...
 */
class FixedSizeChronometer @JvmOverloads constructor(
    context: Context,
...
//  Same resize policy used as in FixedSizeTextView. Uncomment if missing.
